<?php
	...
	$config = array(
		// REQUIRED VALUES ------------------------------------
		'twitter_screenname' => '_davidhiggins_', // Your Twitter screen name
		'timezone'           => 'Europe/Dublin', // Choose one of these: http://php.net/manual/en/timezones.php
		'path'               => '/twitter', // Where's your twitter installation on your domain? No end slash, please.
		// Database values
		'db'                 => array(
			'hostname'       => 'twitterz.db.8642489.hostedresource.com', // The hostname of your database server. Usually 'localhost'
			'username'       => 'twitterz', // The username to log in to your database
			'password'       => 'popeyexox1A*', // The password to log in to your database
			'database'       => 'twitterz', // The database name
		...
		'maintenance_http_password' => 'doobtwitter5', 
